...
{
	public partial class BinoViewController : UIViewController
	{
		...
		public BinoViewController (IntPtr handle) : base (handle)
		{
		}
		...
		public override void ViewDidLoad ()
		{
            ...
            ImgSx.Transform = CGAffineTransform.MakeRotation((float)Math.PI);
            ImgDx.Transform = CGAffineTransform.MakeRotation((float)Math.PI);
			...
			ThisApp.Recorder.DisplayView = ImgSx;
            ThisApp.Recorder.SecondaryDisplayView = ImgDx;
